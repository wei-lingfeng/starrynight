...
alpha=0.2
colors = ['C3', 'C2', 'C4']
sigma_rv_line = ax.hlines(vdisp_vr, xmin=xmin, xmax=xmax, colors=colors[0], linestyles=':', zorder=0)
sigma_rv_fill = ax.fill_between([xmin, xmax], y1=[vdisp_vr - vdisp_vr_e]*2, y2=[vdisp_vr + vdisp_vr_e]*2, color=colors[0], alpha=alpha, zorder=0)
