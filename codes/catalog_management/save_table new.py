...
result_table['APOGEE']          = MaskedColumn(result_df['APOGEE'], mask=result_df['APOGEE'].isna(), format=str, description='Identifier in APOGEE-2 DR16 [2020AJ....160..120J]')
result_table['Gaia DR3']        = MaskedColumn(result_df['Gaia DR3'], mask=result_df['Gaia DR3'].isna(), format=str, description='Identifier in Gaia DR3 [2023A&A...674A...1G]')
...
result_table['Veil Param O32']  = MaskedColumn(result_df['Veil Param O32'], mask=result_df['Veil Param O32'].isna(), unit=u.dimensionless_unscaled, description='Veiling parameter in order 32. Defined as in Theissen et al. (2022) [2022ApJ...926..141T]')
result_table['Veil Param O33']  = MaskedColumn(result_df['Veil Param O33'], mask=result_df['Veil Param O33'].isna(), unit=u.dimensionless_unscaled, description='Veiling parameter in order 32. Defined as in Theissen et al. (2022) [2022ApJ...926..141T]')
